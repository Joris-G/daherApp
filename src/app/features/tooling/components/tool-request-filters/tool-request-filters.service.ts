...
import { ToolRequestListStore } from "src/app/features/tooling/stores/tool-request-list.store";
import { ToolRequest } from "src/app/features/tooling/models/tool-request.model";
