...
// src/app/shared/directives/header-row.directive.ts
var HeaderRowDirective = class HeaderRowDirective2 {
  elemRef;
  renderer;
...
// src/app/shared/directives/data-row.directive.ts
var DataRowDirective = class DataRowDirective2 {
  elemRef;
  renderer;
  isUrgent;
  constructor(elemRef, renderer) {
