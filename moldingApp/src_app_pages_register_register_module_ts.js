...
let RoleService = class RoleService {
    ...
    getRoles() {
        return this.requestService.createGetRequest(src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.moldingApi + 'postes');
    }
};
...
let SericesService = class SericesService {
    ...
    getServices() {
        return this.requestService.createGetRequest(src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.moldingApi + 'services');
    }
};
...
/* harmony import */ var _C_Users_j_grangier_Desktop_TRAVAIL_Appli_MOULAGE_moldingApp_node_modules_ngtools_webpack_src_loaders_direct_resource_js_register_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./register.page.html */ 12004);
...
/* harmony import */ var src_app_services_users_role_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_services/users/role.service */ 39104);
/* harmony import */ var src_app_services_users_serices_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_services/users/serices.service */ 94552);
/* harmony import */ var src_app_services_users_users_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/_services/users/users.service */ 82048);
...
let RegisterPage = class RegisterPage {
    constructor(router, serviceService, roleService, loadingController, userService, alertController, alertService) {
        this.router = router;
        ...
        this.roleForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormGroup({
            poste: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(),
            service: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(),
        });
        this.identityForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormGroup({
            ...
            matricule: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(),
            password: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(),
            telephone: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormControl(),
        });
        this.getDatas();
    }
    getDatas() {
    ...
    submitRole() {
        ...
        if (this.roleForm.value.poste !== 1) {
            this.identityForm.get('password').setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_6__.Validators.required);
        }
...
RegisterPage.ctorParameters = () => [
    ...
    { type: src_app_services_users_serices_service__WEBPACK_IMPORTED_MODULE_4__.SericesService },
    { type: src_app_services_users_role_service__WEBPACK_IMPORTED_MODULE_3__.RoleService },
...
RegisterPage.propDecorators = {
    slider: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_10__.ViewChild, args: ['slider',] }]
};
...
module.exports = ".full-height {\n  height: 100% !important;\n}\n\nion-slides {\n  height: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
