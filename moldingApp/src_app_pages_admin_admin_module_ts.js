...
/***/ 56640:
/*!******************************************************************!*\
  !*** ./src/app/_services/notifications/notifications.service.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _shared_admin_header_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared-admin-header.component.scss?ngResource */ 34209);
...
/* harmony import */ var src_app_services_notifications_notifications_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_services/notifications/notifications.service */ 56640);
...
/* harmony import */ var _admin_molding_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin-molding.page.scss?ngResource */ 99399);
...
/* harmony import */ var _admin_user_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin-user.page.scss?ngResource */ 30403);
...
/* harmony import */ var src_app_services_users_users_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/_services/users/users.service */ 1824);
...
let AdminUserPage = class AdminUserPage {
    constructor(userService, datePipe, loadingService, alertService, serviceService) {
        ...
        this.userDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__.MatTableDataSource();
...
AdminUserPage.ctorParameters = () => [
    { type: src_app_services_users_users_service__WEBPACK_IMPORTED_MODULE_6__.UsersService },
...
AdminUserPage.propDecorators = {
    newUsersCanvas: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ViewChild, args: ['newUsers',] }]
};
AdminUserPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
...
/* harmony import */ var src_app_services_users_serices_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/_services/users/serices.service */ 74337);
...
AdminPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_12__.NgModule)({
        ...
        providers: [
            ...
            src_app_services_users_serices_service__WEBPACK_IMPORTED_MODULE_10__.SericesService
        ]
    })
], AdminPageModule);
...
/* harmony import */ var _admin_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin.page.scss?ngResource */ 61586);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
