...
/* harmony import */ var _users_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./users.service */ 2048);
/* harmony import */ var src_assets_fakeDatas_user_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/assets/fakeDatas/user.json */ 3039);
    ...
    authenticate(userName, password) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.production) {
                ...
                this.isAuth = true;
                this.authUser = src_assets_fakeDatas_user_json__WEBPACK_IMPORTED_MODULE_2__;
                resolve(true);
            }
        });
    }
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_admin_admin_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/admin/admin.module */ 1359)).then(m => m.AdminPageModule)
    },
];
...
/***/ 3039:
/*!****************************************!*\
  !*** ./src/assets/fakeDatas/user.json ***!
  \****************************************/
/***/ ((module) => {

"use strict";
module.exports = JSON.parse('{"id":5,"username":"j.grangier","nom":"GRANGIER","prenom":"JORIS","matricule":"0204292","mail":"j.grangier@daher.com","role":"ADMIN"}');
