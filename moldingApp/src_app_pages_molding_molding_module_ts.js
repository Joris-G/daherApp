...
/***/ 78449:
/*!*****************************************************************!*\
  !*** ./src/app/_interfaces/molding/composite-material-types.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AdditionalMaterial": () => (/* binding */ AdditionalMaterial),
/* harmony export */   "Core": () => (/* binding */ Core),
/* harmony export */   "Densif": () => (/* binding */ Densif),
/* harmony export */   "Kit": () => (/* binding */ Kit)
/* harmony export */ });
class Core {
    constructor(idCore, batchNumber, reference) {
        this.idCore = idCore;
        this.batchNumber = batchNumber;
        this.reference = reference;
    }
    static isCore(inputValue) {
        return Object.getOwnPropertyNames(inputValue).includes('idCore');
    }
}
class Kit {
    static isKit(objTotest) {
...
/***/ 38755:
/*!*********************************************!*\
  !*** ./src/app/_interfaces/tooling/tool.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 2914:
/*!********************************************************!*\
  !*** ./src/app/_services/molding/core/core.service.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 54968:
/*!*******************************************************************!*\
  !*** ./src/app/_services/molding/modal/modal-material.service.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var src_app_pages_molding_components_non_expired_material_input_non_expired_material_input_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/pages/molding/_components/non-expired-material-input/non-expired-material-input.component */ 35677);
    ...
    createModal(scanInputValue) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            ...
            const modalMaterial = yield this.modalCtrl.create({
                component: src_app_pages_molding_components_non_expired_material_input_non_expired_material_input_component__WEBPACK_IMPORTED_MODULE_0__.NonExpiredMaterialInputComponent,
...
/***/ 45090:
/*!*****************************************************************************!*\
  !*** ./src/app/_services/molding/otherMaterials/other-materials.service.ts ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var src_app_services_request_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/_services/request.service */ 48219);
...
let OtherMaterialsService = class OtherMaterialsService {
    ...
    addOne(mat) {
        this.requestService.createPostRequest(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.moldingApi}/additional_materials`, mat)
            .subscribe(() => {
...
OtherMaterialsService.ctorParameters = () => [
    { type: src_app_services_request_service__WEBPACK_IMPORTED_MODULE_0__.RequestService }
];
...
/* harmony import */ var src_app_services_molding_core_core_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/_services/molding/core/core.service */ 2914);
/* harmony import */ var src_app_services_molding_kits_kit_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/_services/molding/kits/kit.service */ 5375);
...
/* harmony import */ var _molding_modal_modal_material_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../molding/modal/modal-material.service */ 54968);
...
let ScanService = class ScanService {
    constructor(kitService, toolService, coreService, materialModalService) {
...
ScanService.ctorParameters = () => [
    { type: src_app_services_molding_kits_kit_service__WEBPACK_IMPORTED_MODULE_1__.KitService },
    { type: src_app_services_tooling_tools_tool_service__WEBPACK_IMPORTED_MODULE_2__.ToolService },
    { type: src_app_services_molding_core_core_service__WEBPACK_IMPORTED_MODULE_0__.CoreService },
    { type: _molding_modal_modal_material_service__WEBPACK_IMPORTED_MODULE_3__.ModalMaterialService }
];
ScanService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/***/ 46929:
/*!*********************************************************************************************!*\
  !*** ./src/app/pages/molding/_components/non-expired-material-input/nida/nida.component.ts ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 34929);
/* harmony import */ var _nida_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nida.component.html?ngResource */ 37855);
/* harmony import */ var _nida_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nida.component.scss?ngResource */ 55850);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 3184);
...
let NidaComponent = class NidaComponent {
    constructor() {
        this.nidaEmitter = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.EventEmitter();
        this.material = {
            idCore: null,
            reference: '',
            batchNumber: ''
    ...
    ngOnInit() {
        ...
        this.references$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(['73P5522130C00301', '73P5522148C00401', '73P5522358C00301']);
    }
    validate() {
...
NidaComponent.propDecorators = {
    nidaEmitter: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Output }],
    batchNumberInput: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input }]
};
NidaComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/***/ 35677:
/*!**************************************************************************************************************!*\
  !*** ./src/app/pages/molding/_components/non-expired-material-input/non-expired-material-input.component.ts ***!
  \**************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 34929);
/* harmony import */ var _non_expired_material_input_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./non-expired-material-input.component.html?ngResource */ 14147);
/* harmony import */ var _non_expired_material_input_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./non-expired-material-input.component.scss?ngResource */ 56478);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var src_app_interfaces_molding_composite_material_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/_interfaces/molding/composite-material-types */ 78449);
...
let NonExpiredMaterialInputComponent = class NonExpiredMaterialInputComponent {
    constructor() {
        this.typeInputEv = new _angular_core__WEBPACK_IMPORTED_MODULE_3__.EventEmitter();
    }
    ngOnDestroy() {
        this.materialObject.unsubscribe();
    }
    ngOnInit() {
        if (src_app_interfaces_molding_composite_material_types__WEBPACK_IMPORTED_MODULE_2__.Core.isCore(this.batchNumber)) {
...
NonExpiredMaterialInputComponent.propDecorators = {
    materialObject: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__.Input }],
    batchNumber: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__.Input }],
    typeInputEv: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__.Output }],
    materialSegment: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__.ViewChild, args: ['materialSegment',] }]
};
NonExpiredMaterialInputComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/***/ 48517:
/*!**********************************************************************************************!*\
  !*** ./src/app/pages/molding/_components/scan-molding-input/scan-molding-input.component.ts ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _scan_molding_input_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scan-molding-input.component.html?ngResource */ 59945);
/* harmony import */ var _scan_molding_input_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scan-molding-input.component.scss?ngResource */ 65833);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 3184);
...
/* harmony import */ var src_app_services_scan_scan_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_services/scan/scan.service */ 64980);
...
let ScanMoldingInputComponent = class ScanMoldingInputComponent {
     ...
     */
    constructor(scanService, loadingService, alertService, alertCtrl) {
         ...
         * @memberof ScanMoldingInputComponent
         */
        this.evOnInput = new _angular_core__WEBPACK_IMPORTED_MODULE_5__.EventEmitter();
    }
    /**
    ...
    onInputChange(inputValue) {
        ...
        this.scanService.getScanInput(inputValue).subscribe((input) => {
            ...
            console.error(error);
            this.scanInput.value = '';
            this.alertService.simpleAlert('Erreur lors du scan', 'L\'élement scanné ne correspond à rien de connu', 'Ré-essayer ou contacter j.grangier 06.87.89.24.25');
        });
    }
};
ScanMoldingInputComponent.ctorParameters = () => [
    { type: src_app_services_scan_scan_service__WEBPACK_IMPORTED_MODULE_4__.ScanService },
...
ScanMoldingInputComponent.propDecorators = {
    scanInput: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.ViewChild, args: ['scanInput',] }],
    scanButton: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.ViewChild, args: ['scanButton',] }],
    evOnInput: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.Output }]
};
ScanMoldingInputComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
/* harmony import */ var _create_molding_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create-molding.page.html?ngResource */ 32394);
/* harmony import */ var _create_molding_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create-molding.page.scss?ngResource */ 76933);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/material/expansion */ 12928);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/router */ 52816);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic/angular */ 93819);
/* harmony import */ var src_app_interfaces_molding_composite_material_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/_interfaces/molding/composite-material-types */ 78449);
/* harmony import */ var src_app_interfaces_tooling_tool__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_interfaces/tooling/tool */ 38755);
/* harmony import */ var src_app_services_divers_alert_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_services/divers/alert.service */ 2853);
...
/* harmony import */ var src_app_services_scan_scan_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/_services/scan/scan.service */ 64980);
/* harmony import */ var src_app_services_users_auth_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/_services/users/auth.service */ 27704);
/* harmony import */ var src_app_services_users_role_guard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/_services/users/role.guard */ 82833);
...
let CreateMoldingPage = class CreateMoldingPage {
    constructor(scanService, moldingService, alertController, kitService, router, navCtrl, loadingService, activatedRoute, authService, alertService, roleGuard) {
        this.scanService = scanService;
     ...
     */
    onInput(inputValue) {
        if (src_app_interfaces_molding_composite_material_types__WEBPACK_IMPORTED_MODULE_2__.Kit.isKit(inputValue)) {
            this.onKitInput(inputValue);
            return;
        }
        if (src_app_interfaces_tooling_tool__WEBPACK_IMPORTED_MODULE_3__.Tool.isTool(inputValue)) {
            this.onToolInput(inputValue);
            return;
        }
        if (src_app_interfaces_molding_composite_material_types__WEBPACK_IMPORTED_MODULE_2__.Core.isCore(inputValue)) {
            console.log('is Core');
            this.onMatInput(inputValue);
            return;
        }
        ...
        this.checkMoldingDatas()
            ...
            this.saveMolding()
                ...
                if (print) {
                    ...
                    this.alertService.presentAlertConfirm('Enregistrement effectué', 'Voulez-vous imprimer la fiche ?')
                        .then((response) => { if (response) {
                        this.printMolding();
                    } });
                }
            }, () => {
                this.alertService.simpleAlert('Erreur de sauvegarde', 'Le moulage n\'a pas été sauvegardé', 'Veuillez ré-essayer');
            });
        }, () => {
            console.error('test');
        });
            ...
            this.checkMoldingDatas()
                ...
                if (this.molding.id === null) {
                    ...
                    this.moldingService.updateMolding(this.moldingService.toIri(this.molding))
                        ...
                        this.alertService.simpleAlert('Message d\'erreur', 'Sauvegarde échouée !', 'La sauvegarde ne s\'est pas correctement effectuée. Veuillez recommencer');
...
CreateMoldingPage.ctorParameters = () => [
    { type: src_app_services_scan_scan_service__WEBPACK_IMPORTED_MODULE_8__.ScanService },
    { type: src_app_services_molding_moldings_molding_service__WEBPACK_IMPORTED_MODULE_7__.MoldingService },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_11__.AlertController },
    { type: src_app_services_molding_kits_kit_service__WEBPACK_IMPORTED_MODULE_6__.KitService },
    ...
    { type: src_app_services_users_auth_service__WEBPACK_IMPORTED_MODULE_9__.AuthService },
    { type: src_app_services_divers_alert_service__WEBPACK_IMPORTED_MODULE_4__.AlertService },
    { type: src_app_services_users_role_guard__WEBPACK_IMPORTED_MODULE_10__.RoleGuard }
];
CreateMoldingPage.propDecorators = {
    accordion: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_13__.ViewChild, args: [_angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__.MatAccordion,] }],
    kitPanel: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_13__.ViewChild, args: ['kitPanel',] }]
};
CreateMoldingPage = (0,tslib__WEBPACK_IMPORTED_MODULE_15__.__decorate)([
...
/* harmony import */ var src_app_services_users_auth_guard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/_services/users/auth.guard */ 34699);
/* harmony import */ var _pages_molding_create_molding_create_molding_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../pages/molding/create-molding/create-molding.page */ 80535);
/* harmony import */ var _molding_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./molding.page */ 39471);
/* harmony import */ var _print_molding_sheet_print_molding_sheet_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./print-molding-sheet/print-molding-sheet.page */ 19771);
...
const routes = [
    {
        path: '',
        component: _molding_page__WEBPACK_IMPORTED_MODULE_2__.MoldingPage,
        children: [
            {
                path: 'print-molding-sheet/:id',
                canActivate: [src_app_services_users_auth_guard__WEBPACK_IMPORTED_MODULE_0__.AuthGuard],
                component: _print_molding_sheet_print_molding_sheet_page__WEBPACK_IMPORTED_MODULE_3__.PrintMoldingSheetPage
            },
            {
            ...
            },
            {
                path: 'create-molding',
                canActivate: [src_app_services_users_auth_guard__WEBPACK_IMPORTED_MODULE_0__.AuthGuard],
                component: _pages_molding_create_molding_create_molding_page__WEBPACK_IMPORTED_MODULE_1__.CreateMoldingPage,
            },
            {
...
MoldingPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/* harmony import */ var _molding_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./molding-routing.module */ 72222);
/* harmony import */ var _molding_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./molding.page */ 39471);
/* harmony import */ var src_app_composants_shared_user_header_shared_user_header_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/composants/shared-user-header/shared-user-header.module */ 68890);
...
/* harmony import */ var _create_molding_create_molding_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./create-molding/create-molding.page */ 80535);
...
/* harmony import */ var src_app_services_scan_scan_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/_services/scan/scan.service */ 64980);
/* harmony import */ var src_app_services_molding_kits_kit_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/_services/molding/kits/kit.service */ 5375);
/* harmony import */ var src_app_services_molding_moldings_molding_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/_services/molding/moldings/molding.service */ 79528);
/* harmony import */ var src_app_services_tooling_tools_tool_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/_services/tooling/tools/tool.service */ 14224);
/* harmony import */ var _components_scan_molding_input_scan_molding_input_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./_components/scan-molding-input/scan-molding-input.component */ 48517);
/* harmony import */ var _print_molding_sheet_print_molding_sheet_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./print-molding-sheet/print-molding-sheet.page */ 19771);
/* harmony import */ var _components_non_expired_material_input_non_expired_material_input_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./_components/non-expired-material-input/non-expired-material-input.component */ 35677);
/* harmony import */ var src_app_services_molding_modal_modal_material_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/_services/molding/modal/modal-material.service */ 54968);
/* harmony import */ var _components_non_expired_material_input_nida_nida_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./_components/non-expired-material-input/nida/nida.component */ 46929);
/* harmony import */ var src_app_services_molding_otherMaterials_other_materials_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/_services/molding/otherMaterials/other-materials.service */ 45090);
...
MoldingPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_15__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_16__.NgModule)({
        ...
        declarations: [
            _molding_page__WEBPACK_IMPORTED_MODULE_1__.MoldingPage,
            _create_molding_create_molding_page__WEBPACK_IMPORTED_MODULE_4__.CreateMoldingPage,
            _components_scan_molding_input_scan_molding_input_component__WEBPACK_IMPORTED_MODULE_9__.ScanMoldingInputComponent,
            _print_molding_sheet_print_molding_sheet_page__WEBPACK_IMPORTED_MODULE_10__.PrintMoldingSheetPage,
            _components_non_expired_material_input_non_expired_material_input_component__WEBPACK_IMPORTED_MODULE_11__.NonExpiredMaterialInputComponent,
            _components_non_expired_material_input_nida_nida_component__WEBPACK_IMPORTED_MODULE_13__.NidaComponent,
        ],
        providers: [
            src_app_services_scan_scan_service__WEBPACK_IMPORTED_MODULE_5__.ScanService,
            ...
            src_app_services_tooling_tools_tool_service__WEBPACK_IMPORTED_MODULE_8__.ToolService,
            src_app_services_molding_modal_modal_material_service__WEBPACK_IMPORTED_MODULE_12__.ModalMaterialService,
            src_app_services_molding_otherMaterials_other_materials_service__WEBPACK_IMPORTED_MODULE_14__.OtherMaterialsService,
        ]
    })
], MoldingPageModule);
...
/* harmony import */ var _molding_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./molding.page.html?ngResource */ 79406);
/* harmony import */ var _molding_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./molding.page.scss?ngResource */ 40780);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 3184);
...
/***/ 19771:
/*!*******************************************************************************!*\
  !*** ./src/app/pages/molding/print-molding-sheet/print-molding-sheet.page.ts ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 34929);
/* harmony import */ var _print_molding_sheet_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./print-molding-sheet.page.html?ngResource */ 53479);
/* harmony import */ var _print_molding_sheet_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./print-molding-sheet.page.scss?ngResource */ 88372);
...
/* harmony import */ var src_app_services_divers_loading_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_services/divers/loading.service */ 99172);
/* harmony import */ var src_app_services_molding_kits_kit_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_services/molding/kits/kit.service */ 5375);
/* harmony import */ var src_app_services_molding_moldings_molding_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/_services/molding/moldings/molding.service */ 79528);
...
let PrintMoldingSheetPage = class PrintMoldingSheetPage {
    constructor(activatedRoute, moldingService, loadingService, kitService, router) {
        this.activatedRoute = activatedRoute;
        this.moldingService = moldingService;
        this.loadingService = loadingService;
        this.kitService = kitService;
...
PrintMoldingSheetPage.ctorParameters = () => [
    ...
    { type: src_app_services_molding_moldings_molding_service__WEBPACK_IMPORTED_MODULE_5__.MoldingService },
    { type: src_app_services_divers_loading_service__WEBPACK_IMPORTED_MODULE_3__.LoadingService },
    { type: src_app_services_molding_kits_kit_service__WEBPACK_IMPORTED_MODULE_4__.KitService },
...
/***/ 55850:
/*!**********************************************************************************************************!*\
  !*** ./src/app/pages/molding/_components/non-expired-material-input/nida/nida.component.scss?ngResource ***!
  \**********************************************************************************************************/
/***/ ((module) => {
...
/***/ 56478:
/*!***************************************************************************************************************************!*\
  !*** ./src/app/pages/molding/_components/non-expired-material-input/non-expired-material-input.component.scss?ngResource ***!
  \***************************************************************************************************************************/
/***/ ((module) => {
...
/***/ 65833:
/*!***********************************************************************************************************!*\
  !*** ./src/app/pages/molding/_components/scan-molding-input/scan-molding-input.component.scss?ngResource ***!
  \***********************************************************************************************************/
/***/ ((module) => {

module.exports = "#scan-input {\n  display: flex;\n  width: 200%;\n}\n\n:host {\n  width: 33%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 76933:
/*!**********************************************************************************!*\
  !*** ./src/app/pages/molding/create-molding/create-molding.page.scss?ngResource ***!
  \**********************************************************************************/
/***/ ((module) => {
...
/***/ 40780:
/*!************************************************************!*\
  !*** ./src/app/pages/molding/molding.page.scss?ngResource ***!
  \************************************************************/
/***/ ((module) => {
...
/***/ 88372:
/*!********************************************************************************************!*\
  !*** ./src/app/pages/molding/print-molding-sheet/print-molding-sheet.page.scss?ngResource ***!
  \********************************************************************************************/
/***/ ((module) => {
